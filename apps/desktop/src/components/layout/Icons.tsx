...
export function IconMicOff({ size = 20 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M15 9V5a3 3 0 0 0-5.06-2.1" />
      <path d="M19 11v1a7 7 0 0 1-7 7a7 7 0 0 1-2.1-.32" />
      <path d="M12 19v3" />
      <path d="M8 22h8" />
      <path d="M3 3l18 18" />
    </svg>
...
export function IconScreen({ size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconAiFunction({ size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconProviders({ size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconUpdates({ size = 18 }: IconProps) {
  return (
    <svg
      fill="currentColor"
      width={size}
...
export function IconAccessibility({ size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
