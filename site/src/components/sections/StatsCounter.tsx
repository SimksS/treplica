  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center text-center px-6 max-w-4xl z-10">
        ...
        <span
          ref={numberRef}
          className="font-display text-[9rem] md:text-[18rem] font-black tracking-tighter text-white leading-none selection:bg-white selection:text-black"
        >
          {count}%
        </span>

        {/* Labels and Copy */}
        <h3 className="font-display text-lg md:text-2xl font-bold uppercase tracking-[0.2em] text-white/95 mt-4">
          Segurança Local e Privada
        </h3>
        <p className="text-muted text-sm md:text-base leading-relaxed max-w-lg mt-3">
          Zero dados salvos na nuvem. Suas transcrições, relatórios e documentos gerados são armazenados exclusivamente em banco SQLite local na sua máquina — nenhuma informação trafega pelos nossos servidores.
        </p>
      </div>
    </section>
  );
